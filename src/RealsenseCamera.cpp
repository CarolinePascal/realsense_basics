...
//TODO multiple cameras handling ?
...
bool RealsenseCamera::disparityShiftService(realsense_basics::FloatParameters::Request& req, realsense_basics::FloatParameters::Response& res)
{
    m_mutex = false;
...
bool RealsenseCamera::thresholdFilterService(realsense_basics::FloatParameters::Request& req, realsense_basics::FloatParameters::Response& res)
{
    m_mutex = false;
